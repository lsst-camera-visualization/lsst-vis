...
var LSST_TERMINAL = {
	...
	Utility : {
        ...
        // Returns an alphabetized version of a list of arrays. Does not change the original array.
        // Uses the idx of each entry to sort.
		Alphabetize2 : function(array, idx) {
			var alpha = array.slice();
			var alphaSort = function(a, b) {
				var keyA = a[idx].toLowerCase();
				var keyB = b[idx].toLowerCase();
